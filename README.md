...
```jsx
const myScaleKey = 'l'
const myArrayScale = ['3rem', '4rem', '5rem', '6rem']
const myFuncScale = () => ['4px', '5px', '6px', '7px']

<div mScale={['xl', myScaleKey, myArrayScale, myFuncScale]} />
...
<div
  css={theme => ({
    margin: theme.spaceScales.xl[0],
    "@media (min-width: 40em)": {
      margin: theme.spaceScales[myScaleKey][1]
    },
    "@media (min-width: 52em)": {
      margin: myArrayScale[2]
    },
    "@media (min-width: 64em)": {
      margin: myFuncScale[3]
    }
  })}
/>
```
